...
declare module "@tiptap/core" {
  interface Commands<ReturnType> {
    imageBlock: {
      ...
      setImageBlockBorderRadius: (borderRadius: number) => ReturnType;
    };
  }
}
    ...
    return {
      ...
      align: {
        ...
        renderHTML: (attributes) => ({
          ...
          style: `display: block; margin-left: auto; margin-right: auto; text-align: ${attributes.align}`,
        }),
      },
      alt: {
        default: undefined,
  ...
  addCommands() {
    return {
      ...
      setImageBlockBorderRadius:
        ...
        ({ commands }) =>
          commands.updateAttributes("imageBlock", {
            borderRadius: `${Math.max(0, Math.min(100, borderRadius))}`,
          }),
    };
  },
